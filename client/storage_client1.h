...
*       group_name: specify the group name to upload file to, can be NULL or
*emtpy
*	file_id: return the new created file id (including group name and
*filename)
...
#define storage_upload_by_filebuff1(pTrackerServer, pStorageServer,          \
                                    ...
                                    file_ext_name, meta_list, meta_count,    \
                                    group_name, file_id)                     \
    storage_do_upload_file1(                                                 \
        pTrackerServer, pStorageServer, store_path_index,                    \
        STORAGE_PROTO_CMD_UPLOAD_FILE, FDFS_UPLOAD_BY_BUFF, file_buff, NULL, \
        file_size, file_ext_name, meta_list, meta_count, group_name, file_id)

#define storage_upload_appender_by_filebuff1(                                 \
    pTrackerServer, pStorageServer, store_path_index, file_buff, file_size,   \
    file_ext_name, meta_list, meta_count, group_name, file_id)                \
    storage_do_upload_file1(pTrackerServer, pStorageServer, store_path_index, \
...
#define storage_upload_by_callback1(pTrackerServer, pStorageServer,      \
                                    ...
                                    meta_count, group_name, file_id)     \
    storage_upload_by_callback1_ex(                                      \
        pTrackerServer, pStorageServer, store_path_index,                \
        STORAGE_PROTO_CMD_UPLOAD_FILE, callback, arg, file_size,         \
        file_ext_name, meta_list, meta_count, group_name, file_id)

#define storage_upload_appender_by_callback1(                             \
    pTrackerServer, pStorageServer, store_path_index, callback, arg,      \
    file_size, file_ext_name, meta_list, meta_count, group_name, file_id) \
    storage_upload_by_callback1_ex(                                       \
        pTrackerServer, pStorageServer, store_path_index,                 \
...
#define storage_do_download_file1(pTrackerServer, pStorageServer,         \
                                  download_type, file_id, file_buff,      \
                                  file_size)                              \
    storage_do_download_file1_ex(pTrackerServer, pStorageServer,          \
                                 download_type, file_id, 0, 0, file_buff, \
                                 NULL, file_size)
