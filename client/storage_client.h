...
#define storage_upload_by_filename(pTrackerServer, pStorageServer,       \
                                   store_path_index, local_filename,     \
                                   file_ext_name, meta_list, meta_count, \
                                   group_name, remote_filename)          \
    storage_upload_by_filename_ex(                                       \
        pTrackerServer, pStorageServer, store_path_index,                \
        STORAGE_PROTO_CMD_UPLOAD_FILE, local_filename, file_ext_name,    \
        meta_list, meta_count, group_name, remote_filename)

#define storage_upload_appender_by_filename(                                   \
    ...
    storage_upload_by_filename_ex(                                             \
        pTrackerServer, pStorageServer, store_path_index,                      \
        STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, local_filename, file_ext_name, \
        meta_list, meta_count, group_name, remote_filename)
...
#define storage_upload_by_filebuff(pTrackerServer, pStorageServer,             \
                                   store_path_index, file_buff, file_size,     \
                                   file_ext_name, meta_list, meta_count,       \
                                   group_name, remote_filename)                \
    storage_do_upload_file(pTrackerServer, pStorageServer, store_path_index,   \
                           STORAGE_PROTO_CMD_UPLOAD_FILE, FDFS_UPLOAD_BY_BUFF, \
                           file_buff, NULL, file_size, NULL, NULL,             \
                           file_ext_name, meta_list, meta_count, group_name,   \
                           remote_filename)

#define storage_upload_appender_by_filebuff(                                 \
    pTrackerServer, pStorageServer, store_path_index, file_buff, file_size,  \
    file_ext_name, meta_list, meta_count, group_name, remote_filename)       \
    storage_do_upload_file(pTrackerServer, pStorageServer, store_path_index, \
                           STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE,           \
                           FDFS_UPLOAD_BY_BUFF, file_buff, NULL, file_size,  \
                           NULL, NULL, file_ext_name, meta_list, meta_count, \
                           group_name, remote_filename)
...
#define storage_upload_by_callback(pTrackerServer, pStorageServer,             \
                                   store_path_index, callback, arg, file_size, \
                                   file_ext_name, meta_list, meta_count,       \
                                   group_name, remote_filename)                \
    storage_upload_by_callback_ex(                                             \
        pTrackerServer, pStorageServer, store_path_index,                      \
        STORAGE_PROTO_CMD_UPLOAD_FILE, callback, arg, file_size,               \
        file_ext_name, meta_list, meta_count, group_name, remote_filename)
...
#define storage_upload_appender_by_callback(pTrackerServer, pStorageServer,    \
    ...
    storage_upload_by_callback_ex(                                             \
        pTrackerServer, pStorageServer, store_path_index,                      \
        STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, callback, arg, file_size,      \
        file_ext_name, meta_list, meta_count, group_name, remote_filename)
...
#define storage_do_download_file(pTrackerServer, pStorageServer,               \
    ...
    storage_do_download_file_ex(pTrackerServer, pStorageServer, download_type, \
                                group_name, remote_filename, 0, 0, file_buff,  \
                                arg, file_size);
...
#define storage_query_file_info(pTrackerServer, pStorageServer, group_name, \
                                filename, pFileInfo)                        \
    storage_query_file_info_ex(pTrackerServer, pStorageServer, group_name,  \
                               filename, pFileInfo, false)
