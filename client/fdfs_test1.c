    ...
    if (strcmp(operation, "upload") == 0) {
        ...
        *group_name = '\0';
        ...
        if (upload_type == FDFS_UPLOAD_BY_FILE) {
            ...
            result = storage_upload_by_filename1(
        ...
        *file_id = '\0';
        ...
        if (upload_type == FDFS_UPLOAD_BY_FILE) {
            ...
            result = storage_upload_slave_by_filename1(
                pTrackerServer, NULL, local_filename, master_file_id,
                prefix_name, file_ext_name, meta_list, meta_count, file_id);
        } else if (upload_type == FDFS_UPLOAD_BY_BUFF) {
            char *file_content;
            ...
            if ((result = getFileContent(local_filename, &file_content,
                ...
                result = storage_upload_slave_by_filebuff1(
                    ...
                    master_file_id, prefix_name, file_ext_name, meta_list,
                    meta_count, file_id);
                free(file_content);
            }
        } else {
            ...
            if (stat(local_filename, &stat_buf) == 0 &&
                ...
                result = storage_upload_slave_by_callback1(
                    ...
                    file_size, master_file_id, prefix_name, file_ext_name,
        ...
        if (fdfs_gen_slave_filename(master_file_id, prefix_name, file_ext_name,
        ...
        if (strcmp(operation, "query_servers") == 0) {
            ...
            result = tracker_query_storage_list1(pTrackerServer, storageServers,
                                                 FDFS_MAX_SERVERS_EACH_GROUP,
                                                 &server_count, file_id);

            if (result != 0) {
                printf(
                    "tracker_query_storage_list1 fail, "
                    "file_id=%s, "
                    "error no: %d, error info: %s\n",
        ...
        if ((result = tracker_query_storage_fetch1(
                 pTrackerServer, &storageServer, file_id)) != 0) {
            fdfs_client_destroy();
            printf(
        ...
        if (strcmp(operation, "download") == 0) {
                ...
                if (strcmp(local_filename, "CALLBACK") == 0) {
                    ...
                    if (fp == NULL) {
                        ...
                        result = storage_download_file_ex1(
                            pTrackerServer, pStorageServer, file_id, 0, 0,
                            writeToFileCallback, fp, &file_size);
                        fclose(fp);
                    }
                } else {
                    result = storage_download_file_to_file1(
                        pTrackerServer, pStorageServer, file_id, local_filename,
                        &file_size);
                }
            } else {
                file_buff = NULL;
                if ((result = storage_download_file_to_buff1(
                         pTrackerServer, pStorageServer, file_id, &file_buff,
                         &file_size)) == 0) {
            ...
            if ((result = storage_get_metadata1(pTrackerServer, NULL, file_id,
                                                &pMetaList, &meta_count)) ==
                0) {
                printf(
            ...
            if ((result = storage_set_metadata1(pTrackerServer, NULL, file_id,
                                                pMetaList, meta_count,
                                                *argv[4])) == 0) {
            ...
            if ((result = storage_delete_file1(pTrackerServer, NULL,
                                               file_id)) == 0) {
