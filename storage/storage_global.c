...
char g_tracker_client_ip[IP_ADDRESS_SIZE] = {0};  // storage ip as tracker
                                                  // client
...
byte g_id_type_in_filename =
    FDFS_ID_TYPE_IP_ADDRESS;  // id type of the storage server in the filename
bool g_store_slave_file_use_link = false;  // if store slave file use symbol
                                           // link
