...
int tracker_load_status_from_file(TrackerStatus *pStatus) {
    ...
    pStatus->up_time =
        iniGetIntValue(NULL, TRACKER_STATUS_ITEM_UP_TIME, &iniContext, 0);
    pStatus->last_check_time = iniGetIntValue(
        NULL, TRACKER_STATUS_ITEM_LAST_CHECK_TIME, &iniContext, 0);
